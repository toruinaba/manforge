...
! ======================================================================
      ...
      double precision, parameter :: SQRT15 = 1.2247448713915890d0  ! sq
      integer :: ii, jj
...
! ======================================================================
     ...
     &a_prime)
      ...
      double precision, intent(in)  :: theta(6), theta_max, R, R_n,
     &dlambda
      double precision, intent(out) :: theta_bar, theta_flow(6), C_k, s,
     &a, a_prime
...
! ======================================================================
     ...
     &theta_max, R, R_n, dlambda, jvec)
      implicit none
      double precision, intent(in)  :: B_bnd, Y, k, Rsat, C_1, C_2
      double precision, intent(in)  :: xi(6), theta(6), theta_max, R,
     &R_n, dlambda
      double precision, intent(out) :: jvec(6)
...
! ======================================================================
      ...
      double precision, parameter :: BETA_H = 500.0d0
...
! ======================================================================
     ...
     &k, b_kin, h, Ea, xi_param
      double precision, intent(in)  :: stress_new(6), theta_new(6),
     &beta_new(6)
      double precision, intent(in)  :: R_new, eps_eq_new
      double precision, intent(in)  :: theta_n(6), beta_n(6),
     &theta_max_n
...
! ======================================================================
     ...
     &k, b_kin, h, Ea, xi_param
      double precision, intent(in)  :: stress_new(6), theta_new(6),
     &beta_new(6)
      double precision, intent(in)  :: R_new, eps_eq_new, theta_max_new,
     &R_n, dlambda
...
! ======================================================================
     ...
     &R_n, dlambda
      ...
      double precision, intent(in)  :: eps_eq_n  ! step-start eps_eq for

      double precision :: jac(19,19), C(6,6), C_n(6,6), C_inv(6,6),
     &C_work(6,6)
...
! -- inputs: stress + state at step start
      ...
      double precision, intent(in) :: theta_n(6), beta_n(6), Rbnd_n,
...
! -- outputs: updated stress + state
      ...
      double precision, intent(out) :: theta_out(6), beta_out(6),
...
! -- local variables
      ...
      logical :: g_latched
      double precision :: Gn, Fn, mu, delta_q(6), delta_rstag,
     &delta_Rbnd, s_fac
...
! ======================================================================
     ...
     &DRPLDE(NTENS)
      ...
      double precision,     intent(in)    :: DROT(3,3), DFGRD0(3,3),
     &DFGRD1(3,3)
     ...
     &Rbnd_out
      ...
      double precision :: theta_out_rot(6), beta_out_rot(6),
     &q_out_rot(6)
